...
import { AboutInterface } from "../interface/Interface";
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const aboutData: AboutInterface = await aboutRes.json();
